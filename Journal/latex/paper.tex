...
\bibliography{ThesisEx}		% expects file "myrefs.bib"

\section{Figures}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=9cm, height=12cm]{2/ex1.eps}}{\caption{The ROC surface for $k_1$, $k_2$ range from $-30$ to $30$ with step $0.05$.}\label{fig: 2.1}}
             \ffigbox{\includegraphics[width=9cm, height=12cm]{2/ex2.eps}}{\caption{The ROC surface for problem \eqref{2015jan29a2}}\label{fig: 2.2mar9}}
           \end{floatrow}
\end{figure}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=9cm, height=12cm]{2/ex3.eps}}{\caption{The contour for the ROC surface.}\label{fig: 2.3mar9}}
             \ffigbox{\includegraphics[width=9cm, height=12cm]{2/example_pic.eps}}{\caption{Relationship between $G'$ and $G_s$.}\label{fig: feb18}}
           \end{floatrow}
\end{figure}

\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{\includegraphics[width=9cm, height=12cm]{3/singleROC.eps}}{\caption{Region that can be achieved by Neyman Pearson testing with $k_i \geq 0 (i=1, ..., M)$.}\label{pic: surface for m0 gaussian}}
             \ffigbox{\includegraphics[width=9cm, height=12cm]{3/singlecontour.eps}}{\caption{Region that can be achieved by Neyman Pearson testing with $k_i \geq 0 (i=1, ..., M)$.}\label{pic: contour for m0 gaussian}}
           \end{floatrow}
\end{figure}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{
             \includegraphics[width=9cm, height=12cm]{3/ROC2.eps}}
			 {\caption{The M-ROC surface for Gaussian Hypotheses.}
			\label{pic: LJS}
             }
             \ffigbox{
             \includegraphics[width=9cm, height=12cm]{3/example3.eps}}
...
\begin{figure}[!h]
           \begin{floatrow}
             \ffigbox{
             \includegraphics[width=9cm, height=13cm]{5/SIa.eps}}
