...
We assume we have all the knowledge of $s_A$, $s_B$ and noise.   
...
\begin{figure}[!t]
  ...
  \label{pic:1222a0}
\end{figure}
Similar to \cite{lunden2007spectrum}, in our system the measuring device observes the noisy version of the received signals and forms the cyclic-covariance of their sampled version. With this statistics, the testing device employs the MENP framework to determine the status of the channel. The input of measuring device is
\begin{equation}
...
From the definition of $\Theta_{\tau_0}$, we can see under both $H_1$ or $H_2$, the autocorrelation of $s_A$ or $s_B$ change periodically as a function of $i$. Hence we can conclude the OFDM signals is cyclostationary.  
