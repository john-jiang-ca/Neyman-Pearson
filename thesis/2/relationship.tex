...
We see that in order to minimize $r(\delta_B)$, $\mathcal{C}_0$ has to be chosen as in \eqref{2015feb04a1}. All the other decision region $\mathcal{C}_i$ ($i = 1, 2, \dots M$) can be chosen arbitrary, since they do not affect \eqerf{r00}. A decision rule that employs only $\mathcal{C}_0$ is given by  
\begin{equation}
