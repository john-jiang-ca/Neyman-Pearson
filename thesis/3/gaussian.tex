...
By comparing Figure \ref{pic: LJS} with Figure \ref{pic: contour for m0 gaussian}, we can see the projection of $M_1$ on $c_1-c_2$ plane is set $N_1$, and the projection of $M_2$ on $c_1-c_2$ plane is set $N_2$. 
