...
As we can observe from Figure \ref{pic: LJS}, when one of $c_1$, $c_2$ increases and the other does not change, the value of $P_d$ will either remain the same or increase; when both $c_1$ and $c_2$ increase, $P_d$ will increase. Besides that, it can also be seen, for a given $P_d \in (0, 1)$, there are countable $c_1, c_2$ combinations can achieve this $P_d$.   
...
As we can observe from Figure \ref{pic: surface for same variance}, when one of $c_1$ or $c_2$ increase and the other remain the same, the value of $P_d$ will either remain the same or increase. When both $c_1$ and $c_2$ increase, $P_d$ will increase. Besides that, it can also be seen, for a given $P_d \in (0, 1)$, there are countable $c_1, c_2$ combinations can achieve this $P_d$.   
